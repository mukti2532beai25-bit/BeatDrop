    ...
    return (
        <div className="full-page">
            ...
            <section className="plans-section">
                <h2 className="plans-section-heading">
                    Pick your plan
                </h2>

                <p className="plans-section-subheading">
                    Pay with UPI, Paytm, Net Banking, or Cards
                </p>
            ...
            <footer className="footer">
                <p>
                    © 2026 Beat Drop India Private Limited.
                    All rights reserved.
                </p>
            </footer>
        </div>
